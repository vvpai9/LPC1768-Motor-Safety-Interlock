...
The directory "CMSIS" contains the Device Support Library for the EFM32G 
series of microcontrollers from Energy Micro.

================ About CMSIS =================================================

The DSL is based on CMSIS, the Cortex Microcontroller Software Interface 
...
Keil uVision "MDK-ARM" Beta 4.0 or later, see http://www.keil.com
