...
void LED_ON(u8 LED)
{
  switch (LED)
  {
    ...
    case LD3:   GPIO_WriteBit(GPIO0, GPIO_Pin_16, Bit_RESET);  break;
    case LD4:   GPIO_WriteBit(GPIO2, GPIO_Pin_18, Bit_RESET);  break;
    case LD5:   GPIO_WriteBit(GPIO2, GPIO_Pin_19, Bit_RESET);  break;
    default:;
  }
}
...
void LED_OFF(u8 LED)
{
  switch (LED)
  {
    ...
    case LD3:   GPIO_WriteBit(GPIO0, GPIO_Pin_16, Bit_SET);  break;
    case LD4:   GPIO_WriteBit(GPIO2, GPIO_Pin_18, Bit_SET);  break;
    case LD5:   GPIO_WriteBit(GPIO2, GPIO_Pin_19, Bit_SET);  break;
    default:;
  }
}
