...
; $Id::$
; 
; Project: lpc315x interrupt and exception vectors
;
; Description:
...
vec_reset_handler
    DCD  lpc315x_reset_handler

vec_undefined_handler
    DCD  lpc315x_undefined_handler

vec_swi_handler
    DCD  lpc315x_swi_handler

vec_prefetch_handler
    DCD  lpc315x_prefetch_handler

vec_abort_handler
    DCD  lpc315x_abort_handler

vec_irq_handler
    DCD  lpc315x_irq_handler

vec_fiq_handler
    DCD  lpc315x_fiq_handler

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;
; Function: lpc315x_reset_handler
;
; Purpose:
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
lpc315x_reset_handler
    B    lpc315x_reset_handler

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;
; Function: lpc315x_undefined_handler
;
; Purpose:
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
lpc315x_undefined_handler
    B    lpc315x_undefined_handler

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;
; Function: lpc315x_swi_handler
;
; Purpose:
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
lpc315x_swi_handler
    B    lpc315x_swi_handler

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;
; Function: lpc315x_prefetch_handler
;
; Purpose:
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
lpc315x_prefetch_handler
    B    lpc315x_prefetch_handler

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;
; Function: lpc315x_abort_handler
;
; Purpose:
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
lpc315x_abort_handler
    B    lpc315x_abort_handler

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;
; Function: lpc315x_irq_handler
;
; Purpose:
