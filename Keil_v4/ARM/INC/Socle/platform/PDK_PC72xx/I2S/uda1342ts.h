...
extern int uda1342ts_dac_master_volume(u16 val);
extern int uda1342ts_dac_mixer_volume(u16 val);
extern int uda1342ts_dac_enable_mixer(bool val);
extern int uda1342ts_dac_mode(u16 mode);
extern int uda1342ts_dac_bass_boost(u8 val);
extern int uda1342ts_dac_treble(u8 val);
extern int uda1342ts_dac_mute(bool val);
extern int uda1342ts_dac_de_emphasis(u16 val);
extern int uda1342ts_adc_mode(u16 val);
extern int uda1342ts_adc_input_amplifier_gain(u8 reg, u16 val);
extern int uda1342ts_adc_mixer_gain(u8 reg, u16 val);
extern int uda1342ts_output_dc_filter(bool val);
extern int uda1342ts_mixer_dc_filter(bool val);
