...
#define SOCLE_SPI_SOFT_N_RST 0x0 /* don't reset the SPI master core logic */
#define SOCLE_SPI_SOFT_RST (0x1 << 11) /* reset the SPI master core logic */

/* SPI master enable (SPIEN). This enable the SPI master core */
#define SOCLE_SPI_DIS 0x0	/* disable the SPI master */
#define SOCLE_SPI_EN (0x1 << 10) /* enable the SPI master */
