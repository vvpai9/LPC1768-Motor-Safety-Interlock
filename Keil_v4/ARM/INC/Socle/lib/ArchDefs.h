 ...
 * Notes:
 *
 * Id: ArchDefs.h,v 1.103 2002/11/18 22:51:42 uhler Exp $
 *
 */
...
#if defined(MIPSAVPENV) || defined(__ASSEMBLER__) || defined(__assembler)
    #undef UINT64_C
    #undef INT64_C

    #define UINT64_C(c) c
    #define INT64_C(c) c
#endif /* defined(MIPSAVPENV) || defined(__ASSEMBLER__) || defined(__assembler) */
...
#define M_M16_InstnOffset	(0x3ff << S_M16_InstnOffset)
 ...
 *  5 4 3 2 1 0 9 8 7 6 5 4 3 2 1 0
 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 * |  Opcode | rx  | ry  |f| immed |
 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 */

#define	S_M16_InstnF		4
#define	M_M16_InstnF		(0x1 << S_M16_InstnF)
#define S_M16_InstnOffset4	0
#define M_M16_InstnOffset4	(0xf << S_M16_InstnExtendOffset4)
...
#define S_M16_InstnExtendOffset15	S_M16_InstnFunc
#define M_M16_InstnExtendOffset15	S_M16_InstnFunc
#define S_M16_InstnExtendOffset10	S_M16_InstnBPcode
#define M_M16_InstnExtendOffset10	S_M16_InstnBPcode
...
#define M_M16_InstnRa		(0x7 << S_M16_InstnRa)
#define S_M16_InstnS0		5
#define M_M16_InstnS0		(0x7 << S_M16_InstnS0)
#define S_M16_InstnS1		4
#define M_M16_InstnS1		(0x7 << S_M16_InstnS1)
...
#define K_PRIdImp_Amethyst	0x88	/* MIPS64 25Kf with TLB MMU and Release 1 Architecture */
...
#define M_EBase0Fields		0x4000c000
...
#define S_Config3ISP		3			/* Denotes instruction scratchpad RAM present (R) */
#define M_Config3ISP		(0x1 << S_Config3ISP)
#define S_Config3DSP		2			/* Denotes data scratchpad RAM present (R) */
#define M_Config3DSP		(0x1 << S_Config3DSP)
...
#define	M_FP_DOUBLE_SIGN		(0x1 << S_FP_DOUBLE_SIGN)
#define	S_FP_DOUBLE_EXPO		52
#define	M_FP_DOUBLE_EXPO		(0x7ff << S_FP_DOUBLE_SIGN)
#define	S_FP_DOUBLE_FRAC		0
#define	M_FP_DOUBLE_FRAC		(0xfffffffffffff << S_FP_DOUBLE_SIGN)
/* only upper half, use ?_FP_SINGLE_* for lower half */
#define	S_FP_PAIREDSINGLE_SIGN	63
#define	M_FP_PAIREDSINGLE_SIGN	(0x1 << S_FP_PAIREDSINGLE_SIGN)
#define	S_FP_PAIREDSINGLE_EXPO	52
#define	M_FP_PAIREDSINGLE_EXPO	(0xff << S_FP_PAIREDSINGLE_SIGN)
#define	S_FP_PAIREDSINGLE_FRAC	32
#define	M_FP_PAIREDSINGLE_FRAC	(0x7fffff << S_FP_PAIREDSINGLE_SIGN)
...
#define S_FIX_LONG_SIGN 		62
#define M_FIX_LONG_SIGN 		(0x1 << S_FIX_LONG_SIGN)
#define S_FIX_LONG_VALUE		0
#define M_FIX_LONG_VALUE		(0x7fffffffffffffff << S_FIX_LONG_VALUE)
