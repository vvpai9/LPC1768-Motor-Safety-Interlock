 ...
 * $Id:: $
 *
 * Project: LPC315X family chip definitions
 *
 * Description:
 *     This file contains chip specific information such as the
 *     physical addresses defines for the LPC315X registers, clock
 ...
 **********************************************************************/
#ifndef LPC315X_CHIP_H
#define LPC315X_CHIP_H
