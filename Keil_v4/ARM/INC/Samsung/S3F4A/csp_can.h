...
/**
* @file name	csp_can.h
* @description	Definitions, Macros and function declarations for CAN module
*                
...
*******************************************************************************/
#define CAN_ERWARNTR		(0x01ul << 1)  /**< Error passive warning                                               transition                     */
...
/*******************************************************************************
*************************   CAN EXTERNAL FUNCTIONS   ***************************
*******************************************************************************/
extern void CSP_CANInit(CSP_CAN_T *const can, U32_T mode_u32);
extern void CSP_CANClose(CSP_CAN_T *const can);
extern void CSP_CANConfigInterrupt(CSP_CAN_T *const can, 
                              			U32_T intMode_u32, 
                                   		U32_T intMask_u32, 
...
extern void CSP_CANReceive(CSP_CAN_T *const can, 
                          		U8_T  interface_u8, 
                           		U8_T  channel_u8, 
                           		U32_T id_u32,
                           		U32_T mask_u32, 
                           		U16_T  control_u16);
extern void CSP_CANTransmit(CSP_CAN_T *const can, 
                           		U8_T  interface_u8, 
                            	U8_T  channel_u8, 
                            	U32_T dataa_u32,
                            	U32_T datab_u32,
                            	U32_T id_u32,
                            	U16_T control_u16);
extern U32_T CSP_CANComputeBT(CSP_CAN_T *const can, 
                      				U32_T     coreClk_u32, 
                       				U32_T     baudRate_u32);
